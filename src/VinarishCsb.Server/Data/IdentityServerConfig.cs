...
using VinarishCsb.Server.Data.Core;
using VinarishCsb.Shared.AuthorizationDefinitions;
using IdentityModel;
using IdentityServer4;
using IdentityServer4.Models;

namespace VinarishCsb.Server.Data
{
    public class IdentityServerConfig
    {
        public const string ApiName = "VinarishCsb_api";
        public const string ApiFriendlyName = "VinarishCsb API";
        public const string AppClientID = "VinarishCsb_spa";
        ...
        public static IEnumerable<IdentityServer4.Models.Client> GetClients()
        {
            ...
            return new List<IdentityServer4.Models.Client>
            {
                ...
                new IdentityServer4.Models.Client
                {
                    ...
                    ClientSecrets = new List<Secret> { new Secret { Value = "VinarishCsb".Sha512() }},
                    Enabled = true,
