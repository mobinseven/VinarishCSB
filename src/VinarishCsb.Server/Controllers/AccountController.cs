    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ApiResponse> Register(RegisterDto parameters)
        {
            try
            {
                ...
                var requireConfirmEmail = Convert.ToBoolean(_configuration["VinarishCsb:RequireConfirmedEmail"] ?? "false");
        ...
        public async Task<ApiResponse> ForgotPassword(ForgotPasswordDto parameters)
        {
            ...
            try
            {
                ...
                string callbackUrl = string.Format("{0}/Account/ResetPassword/{1}?token={2}", _configuration["VinarishCsb:ApplicationUrl"], user.Id, token); //token must be a query string parameter as it is very long
        ...
        public async Task<ApiResponse> Create(RegisterDto parameters)
        {
            try
            {
                ...
                if (Convert.ToBoolean(_configuration["VinarishCsb:RequireConfirmedEmail"] ?? "false"))
                {
                    ...
                    try
                    {
                        ...
                        string callbackUrl = string.Format("{0}/Account/ConfirmEmail/{1}?token={2}", _configuration["VinarishCsb:ApplicationUrl"], user.Id, token);
