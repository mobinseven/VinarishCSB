using AutoMapper;
using VinarishCsb.Server.Authorization;
using VinarishCsb.Server.Data;
using VinarishCsb.Server.Data.Interfaces;
using VinarishCsb.Server.Data.Mapping;
using VinarishCsb.Server.Helpers;
using VinarishCsb.Server.Middleware;
...
namespace VinarishCsb.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var useSqlServer = Convert.ToBoolean(Configuration["VinarishCsb:UseSqlServer"] ?? "false");
            var dbConnString = useSqlServer
                ? Configuration.GetConnectionString("DefaultConnection")
                : $"Filename={Configuration.GetConnectionString("SqlLiteConnectionFileName")}";

            var authAuthority = Configuration["VinarishCsb:IS4ApplicationUrl"].TrimEnd('/');
            ...
            else
            {
                ...
                var useLocalCertStore = Convert.ToBoolean(Configuration["VinarishCsb:UseLocalCertStore"]);
                var certificateThumbprint = Configuration["VinarishCsb:CertificateThumbprint"];
            ...
            services.Configure<IdentityOptions>(options =>
            {
                ...
                if (Convert.ToBoolean(Configuration["VinarishCsb:RequireConfirmedEmail"] ?? "false"))
                {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMiddleware<APIResponseRequestLoggingMiddleware>(Convert.ToBoolean(Configuration["VinarishCsb:EnableAPILogging:Enabled"] ?? "true"));
